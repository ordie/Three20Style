...
//                           lineBreakMode:_lineBreakMode];
    CGSize textSize = MB_MULTILINE_TEXTSIZE(text, font, maxSize);
    if (_numberOfLines) {
...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (CGSize)drawWithString:(NSString *)string
           ...
           lineBreakMode:(NSLineBreakMode)lineBreakMode
{
    ...
    return [self drawWithString:string
                         inRect:rect
                       withFont:font
           ...
           lineBreakMode:(NSLineBreakMode)lineBreakMode
{
    ...
    return MB_MULTILINE_TEXTSIZE(string, font, rect.size);
}
...
- (void)drawText:(NSString*)text context:(TTStyleContext*)context {
  ...
  if (_numberOfLines == 1) {
    ...
    CGPoint leftTop = CGPointMake(titleRect.origin.x+rect.origin.x, titleRect.origin.y+rect.origin.y);
    titleRect.size = [self drawWithString:text
                                  atPoint:leftTop
    ...
    rect.size = [self drawWithString:text
                              inRect:rect
                            withFont:font
                           alignment:_textAlignment
                       lineBreakMode:_lineBreakMode];
