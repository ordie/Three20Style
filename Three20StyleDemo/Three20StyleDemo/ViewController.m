...
CGRect TTNavigationFrame()
{
    ...
    return CGRectMake(0, 0, frame.size.width, frame.size.height - 44);
}
...
- (void)loadView {
    UIScrollView* scrollView = [[UIScrollView alloc] initWithFrame:TTNavigationFrame()];
    ...
    NSArray* styles = [NSArray arrayWithObjects:
                       ...
                       [TTShapeStyle styleWithShape:[TTRoundedRectangleShape shapeWithRadius:TT_ROUNDED] next:
                        [TTInsetStyle styleWithInset:UIEdgeInsetsMake(1.5, 1.5, 1.5, 1.5) next:
                         [TTShadowStyle styleWithColor:RGBACOLOR(0,0,0,0.8) blur:3 offset:CGSizeMake(0, 3) next:
                       ...
                       // Mask
                       [TTMaskStyle styleWithMask:[UIImage imageNamed:@"mask"] next:
